...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      Kode Reservasi : <?php echo $this->uri->segment(3) ?>
    </h1>
  </section>
              ...
              <div class="col-md-10">
                <h3 class="box-title">            
                  <?php foreach ($resv as $r) {
                    echo "Rute : ".$r->kodefrom." - ".$r->from.", ".$r->kotafrom." -> ".$r->kodeto." - ".$r->to.", ".$r->kotato;
                  } ?>
                </h3>
              </div>
            ...
            foreach($resv as $b){ 
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-8">
                          <?php if($b->kd_book == null){
                            echo "Belum Diverifikasi";
                          }else{echo "<b>".$b->kd_book."</b>";}  ?>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-8">
                          <img width="200px" heigth="100px" src="<?php echo base_url('r/').$b->img; ?>">
                        </div>
                      </div>
                  ...
                  <?php if ($b->kd_book == ""){ ?>
                  <form action="<?php echo base_url('admin/confirm'); ?>" method="post">
                    <input type="hidden" name="kode" value="<?php echo $b->kd_resv ?>">
                    <button type="submit" class="btn btn-primary col-md-12">Konfirmasi</button>
                  </form>
