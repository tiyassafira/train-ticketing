            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>
                    <a style="cursor: pointer; color:white;" title="" onclick="href='<?php echo base_url(('admin/edit_transport/'.$t->id)); ?>'"><button class="btn btn-primary" style="height: 26px; padding: 2px; padding-left: 10px; padding-right: 10px;">Edit</button></a>
                   <a style="cursor: pointer; color:white ;" title="" onclick="href='<?php echo base_url(('admin/hapus_transport/'.$t->id)); ?>'"> <button class="btn btn-danger" style="height: 26px; padding: 2px; padding-left: 10px; padding-right: 10px;">Remove</button></a>
                </tr>
                <?php } ?>
                </tbody>
                <tfoot>
