            ...
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
               ...
               foreach($resv as $b){ 
                ...
                <tr>
                  <td><?php echo $no++ ?></td>
                  <td><?php echo $b->kd_resv ?></td>
                  <td><?php echo $b->namapemesan ?></td>
                  <td><?php echo $b->notelpemesan ?></td>
                  <td><?php echo $b->emailpemesan ?></td>
                  <td><?php echo $b->alamatpemesan ?></td>
                  <td><?php echo $b->status ?></td>
                  <td><?php if ($b->img == "" ) { echo "-"; }else{ ?><img height="100px" width="130px" src="<?php echo base_url('r/').$b->img ?>"> <?php } ?>
                  </td>
                  <td><a style="cursor: pointer; color:white;" title="" onclick="href='<?php echo base_url(('admin/detail/'.$b->kd_resv)); ?>'"><button class="btn btn-primary" style="height: 26px; padding: 2px; padding-left: 10px; padding-right: 10px;">Detail</button></a>
