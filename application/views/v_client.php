...
<head>
	...
	<!-- /fonts -->
	<!-- css -->
	<link href="gedang/ticketo/css/bootstrap.css" rel="stylesheet" type='text/css' media="all" />
	<link href="gedang/ticketo/css/style.css" rel="stylesheet" type='text/css' media="all" />
	<!-- /css -->
</head>
...
<body>
	...
	<script src="gedang/ticketo/js/bootstrap.min.js"></script>
	<script src="gedang/ticketo/js/validator.min.js"></script>
	<!-- /js files -->
</body>
