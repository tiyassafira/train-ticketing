            ...
            <div class="box-body">
              ...
              <form action="<?php echo base_url('admin/update_bandara'); ?>" method="post">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="kode" required="true" value="<?php echo $b->kode ?>">
                </div>
                <div class="form-group">
                  <label>Nama Bandara :</label>
                  <input type="text" class="form-control" name="nama" required="true" value="<?php echo $b->nama ?>">
                </div> 
                <div class="form-group">
                  <label>Kota :</label>
                  <input type="text" class="form-control" name="kota" required="true" value="<?php echo $b->kota ?>">
                </div>
